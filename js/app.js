...
new Swiper(".slider-intro__wrapper", {
  ...
  // Dotts
  pagination: {
    el: ".slider-intro__buttons",
    clickable: true,
  },
  //Arrows
  navigation: {
    nextEl: ".slider-intro__arrow_right",
    prevEl: ".slider-intro__arrow_left",
  },
  /*
	breakpoints: {
		320: {
...
//========================================================================================================================================================
let sliderTwo;
sliderTwo = new Swiper(".slider-post__body", {
  // Optional parameters
...
//========================================================================================================================================================
const dItems = document.querySelectorAll(".count__digi");
if (dItems.length > 0) {
